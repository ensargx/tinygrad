...
class Number:
    ...
    def __add__(self, other):
        ...
        new = self._create_child(other, val)
    ...
    def __pow__(self, other):
        ...
        val = self.val ** other
        new = Number(val, (self,), requires_grad=True)
    ...
    def _create_child(self, other, val) -> Number:
        other = other if isinstance(other, Number) else Number(other, requires_grad=False)
        req_grad = self.requires_grad or other.requires_grad
        return Number(val, (self, other), requires_grad=req_grad)
